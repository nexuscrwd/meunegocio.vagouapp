            ...
            <div className="space-y-3 animate-in fade-in duration-200">
              {services.length === 0 ? (
                <div className={`p-8 rounded-[4px] border text-center my-4 ${
                  ...
                  <Scissors className="w-8 h-8 mx-auto mb-2 text-amber-400" />
                  <p className={`text-xs font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Não há serviço ainda cadastrado neste estabelecimento</p>
                  <p className="text-[10px] mt-1 text-slate-400 max-w-sm mx-auto">
                    O estabelecimento ainda não cadastrou a lista de serviços oferecidos.
                  </p>
                </div>
              ) : (
